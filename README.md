...
1. Clone the repo
   ```sh
   cd /tmp/
   git clone https://github.com/SaahilParikh/Strawberry.git
   ```
2. Open the repository
   ```sh
   open /tmp/Strawberry/
   ```
3. Double click on Strawberry.spoon

4. Add the following line to your ```init.lua```
   ```sh
   hs.spoons.use("Strawberry")
   ```
